...
const VideoCarousel = () => {
  ...
  // Fix: Remove loadedData.length > 3 restriction, always allow play/pause
  useEffect(() => {
    ...
    if (currentVideo) {
      if (!isPlaying) {
        ...
        // Try to play, and catch any errors (for browsers that may still restrict)
        currentVideo.play().catch((e) => {
          // Optionally handle play error
  ...
  useEffect(() => {
    ...
    if (span[videoId]) {
      // animate the progess of the video
  ...
  return (
    <div>
        ...
        {hightlightsSlides.map((list, i) => (
          <div key={list.id} id="slider" className="sm:pr-20  pr-10">
            <div className="video-carousel_container">
              <div className="size-full flex-center rounded-3xl bg-black overflow-hidden">
                <video
                  id="video"
                  playsInline={true}
                  preload="auto"
              ...
              <div className="absolute top-12 left-[5%] z-10 text-gray">
      ...
      <div className="relative flex-center mt-10">
        ...
        <button className="bg-gray-300/80 rounded-full p-4 ml-7 backdrop-blur-3xl">
          <Image
            onClick={
              isLastVideo
